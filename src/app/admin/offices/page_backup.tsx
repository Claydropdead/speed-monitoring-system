...
export default function AdminOfficesPage() {
  ...
  const handleAddOffice = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.unitOffice || !formData.location || !formData.isp || !formData.userEmail || !formData.userName || !formData.userPassword) {
  ...
  const handleEditOffice = (office: Office) => {
    console.log('Edit office clicked:', office);
  ...
  const handleUpdateOffice = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Update office:', editFormData);
    if (!editFormData.unitOffice || !editFormData.location || !editFormData.isp) {
      setError('Please fill in all required fields');
      return;
    }
              ...
              <div key={office.id} className={`bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow ${
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span className="ml-1">{office.isp}</span>
                  </div>
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={editFormData.isp || ''}
                        onChange={(e) => setEditFormData({ ...editFormData, isp: e.target.value })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Internet Service Provider"
                        required
                      />
