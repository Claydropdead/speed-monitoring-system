      ...
      <div className="space-y-6">
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 max-w-4xl mx-auto">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-xs text-gray-500 mt-1">Configure automated speed test intervals</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-xs text-gray-500 mt-1">Manage historical data storage policies</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <Shield className="h-6 w-6 text-gray-400 mx-auto mb-2" />
                <h4 className="text-sm font-medium text-gray-900">Security</h4>
                <p className="text-xs text-gray-500 mt-1">Configure authentication and access controls</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <Globe className="h-6 w-6 text-gray-400 mx-auto mb-2" />
                <h4 className="text-sm font-medium text-gray-900">Speed Test Servers</h4>
                <p className="text-xs text-gray-500 mt-1">Manage Ookla server selection and preferences</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="text-sm text-blue-700 mt-1 space-y-1">
                ...
                <p>• Manual configuration can be done through environment variables and code changes</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="text-sm font-medium text-gray-900 mb-2">Available Environment Variables:</h4>
